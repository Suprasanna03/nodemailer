        ...
        <div className='row mt-5 my-auto'>
          <div className='col-lg-6 p-5 rounded bg-white mt-5'>
            ...
            <ul className='list-unstyled'>
              <li className='d-flex'>
                <p className=''><CiLocationOn className='me-1' /> VNR Vignana Jyothi Institute of Engineering & Technology <br /> Pragathi Nagar, Nizampet (S.O), Hyderabad<br /> Telangana, India - 500 090</p>
              </li>
              <li>
                <p><GoMail className='me-1' /> gdscvnrvjiet@gmail.com</p>
              </li>
            </ul>
